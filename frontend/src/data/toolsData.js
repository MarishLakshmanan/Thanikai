import {TableEdit} from "../components/TableComponents/TableEditbtn"
import {EditableCell} from "../components/TableComponents/EditableCell"

const basicInformation = {
  1: [
    {k:"block", name: "Block", type: "text",required:true},
    {k:"panchayat", name: "Panchayat:", type: "text",required:true },
  ...
  3: [
    {k:"numberofworks", name: "Total Number of Works:", type: "number",required:true },
    {k:"worksverified", name: "Number of Works Verified:", type: "number",required:true },
    {k:"householdsworked", name: "Total House Holds Worked:", type: "number",required:true },
    {k:"householdsverified", name: "Total House Holds Verified:", type: "number",required:true },
  ],
  4: [
...
const vrpInfo = [
  ...
  {k:"mobile", name: "Mobile Number", type: "number",required:true },
  {k:"bankname", name: "Bank Name", type: "text",required:true },
...
const issueInfo = [
  {k:"amount", name: "Amount", type: "number",required:true},
  {k:"issueStatus", name: "Issue status", type:"select",values:["Pending","Dropped"],required:true},
  {k:"issue_no", name: "Issue no", type: "number",required:false },
];

const actionInfo = [
  {k:"paraNo",name:"Para no",type:"number",required:true},
  {k:"issueno", name: "Issue no", type: "number",required:true },
  {k:"dateofhlc", name: "Date of hlc", type: "date",required:true },
...
const columns = [
  ...
  {Header:"Issue category",accessor:"issuecategory",disableFilters:true,Cell:EditableCell},
  {Header:"Issue sub-category",accessor:"issuesubcategory",disableFilters:true,Cell:EditableCell},
  {Header:"Total Amount",accessor:"totalamount",Cell:EditableCell},
  {Header:"Issue status",accessor:"issuestatus",Cell:EditableCell},
  {Header:"Proceeding no",accessor:"proceedingnumber",Cell:EditableCell},
  {Header:"Proceeding date",accessor:"proceedingdate",Cell:((data)=>{;return new Date(data.value).toDateString()})},
  {Header:"Amount recovered(SGS)",accessor:"amountrecovered_sgs",Cell:EditableCell},
  {Header:"Amount recovered(HLC)",accessor:"amountrecovered_hlc",Cell:EditableCell},
  {Header:"Based on Document",accessor:"basedondocument",Cell:EditableCell},
  {Header:"Token recovery",accessor:"tokenrecovery",Cell:EditableCell},
  {Header:"Total Recovery(error)",accessor:"amount",Cell:EditableCell},
  {Header:"District",accessor:"district",Cell:EditableCell},
  {Header:"Block",accessor:"block",Cell:EditableCell},
  {Header:"Panchayat",accessor:"panchayat",Cell:EditableCell},
  {Header:"Conducted-In",accessor:"startdate",Cell:((data)=>{;return new Date(data.value).toDateString()})},
  // {Header:"Actions",id:"actions",Filter:ColumnFilter,disableFilters:true,Cell:((data)=>{return <TableEdit data={data}/>})}
]

function changeInput(e,type){
  return <EditableCell value={e.value} column={e.column} row={e.row} editableRowIndex={e.editableRowIndex} updateMyData={e.updateMyData} type={type} deleteDatainDB={e.deleteDatainDB} updateDatainDB={e.updateDatainDB}/>
}

const IssueColumn= [
  {Header:"Basic-info Name" ,accessor:"basicnickname"},
  {Header:"Para no",accessor:"para_no",Cell:(e)=>(changeInput(e,"number"))},
  {Header:"Issue no",accessor:"issue_no",Cell:(e)=>(changeInput(e,"number"))},
  {Header:"Issue type",accessor:"issuetype",disableFilters:true,Cell:(e)=>(changeInput(e,"number"))},
  {Header:"Issue Category",accessor:"issuecategory",disableFilters:true,Cell:(e)=>(changeInput(e,"number"))},
  {Header:"Issue SubCategory",accessor:"issuesubcategory",disableFilters:true,Cell:(e)=>(changeInput(e,"number"))},
  {Header:"Issue Status",accessor:"issuestatus",Cell:(e)=>(changeInput(e,"number"))},
  {Header:"Amount",accessor:"amount",Cell:(e)=>(changeInput(e,"number"))},
  {Header:"Actions",id:"action",disableFilters:true,Cell:TableEdit},
  {Header:"Basic-id",accessor:"basicid"}
]


const ActionColumn = [
  {Header:"Basic-info Name" ,accessor:"basicnickname"},
  {Header:"Para no",accessor:"parano",Cell:(e)=>(changeInput(e,"number"))},
  {Header:"Issue no",accessor:"issueno",Cell:(e)=>(changeInput(e,"number"))},
  {Header:"Date of HLC",accessor:"dateofhlc",Cell:(e)=>(changeInput(e,"date"))},
  {Header:"Proceeding Number",accessor:"proceedingnumber",Cell:(e)=>(changeInput(e,"number"))},
  {Header:"Proceeding Date",accessor:"proceedingdate",Cell:(e)=>(changeInput(e,"date"))},
  {Header:"Total amount",accessor:"totalamount",Cell:(e)=>(changeInput(e,"number"))},
  {Header:"AmountRecovered_sgs",accessor:"amountrecovered_sgs",Cell:(e)=>(changeInput(e,"number"))},
  {Header:"AmountRecovered_hlc",accessor:"amountrecovered_hlc",Cell:(e)=>(changeInput(e,"number"))},
  {Header:"BasedOnDocument",accessor:"basedondocument",Cell:(e)=>(changeInput(e,"number"))},
  {Header:"TokenRecovery",accessor:"tokenrecovery",Cell:(e)=>(changeInput(e,"number"))},
  {Header:"Basic-id",accessor:"basicid"},
  {Header:"Actions",id:"action",disableFilters:true,Cell:TableEdit}

]
//Options are like functions and Properties are like attributes
//Columns options are option given to the column where we enter header accessor and all
//Table options are options given inside useTable
//Instance Propertires are option passed to the tableinstance so that we can destructure it
//column properties are for their instances
export { basicInformation, vrpInfo, issueInfo, actionInfo,issueTypes,issueCategories,issueSubCategories,columns,IssueColumn,ActionColumn};
